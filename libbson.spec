...
# sphinx from SCL doesn't support caption directive
sed -i "/:caption:.*/d" doc/include-and-link.rst
%{?scl:EOF}
...
%changelog
* Fri Feb 23 2018 Marek Skalický <mskalick@redhat.com> - 1.9.2-1
- Rebase to latest upstream version (from F28)
